...
(function(){function hb(){var as=document.querySelectorAll('.backlinks a.internal');var vis=0;as.forEach(function(a){var li=a.closest('li');if(!li)return;if(a.getAttribute('href').match(/^(\\.\\.\\/)+$/)||a.textContent==='踏足大地，翱翔天际。'||a.textContent==='关于本站'){li.style.display='none'}else{vis++}});var bl=document.querySelector('.backlinks');if(bl){bl.style.display=vis===0?'none':''}}hb();setInterval(hb,500)})();
        `}</script>
